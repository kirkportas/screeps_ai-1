...
Creep.prototype.runRemoteHauler = function(creep) {
  ...
  var repairRoads = function(creep) { //
    var foundStruc=  _.find(creep.room.lookForAt(LOOK_STRUCTURES,pos.x,pos.y), s => s instanceof StructureRoad);
    var foundConst = _.find(creep.room.lookForAt(LOOK_CONSTRUCTION_SITES,pos.x,pos.y), s => s.structureType==STRUCTURE_ROAD);
