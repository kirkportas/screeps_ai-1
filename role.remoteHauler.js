...
Creep.prototype.runRemoteHauler = function(creep) {
  ...
  var repairRoads = function(creep) { //
    var foundStruc=  _.find(creep.room.lookForAt(LOOK_STRUCTURES,creep.pos.x,creep.pos.y), s => s instanceof StructureRoad);
    var foundConst = _.find(creep.room.lookForAt(LOOK_CONSTRUCTION_SITES,creep.pos.x,creep.pos.y), s => s.structureType==STRUCTURE_ROAD);
