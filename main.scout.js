    ...
    run: function(room) {
      if (room.memory.scout===undefined||room.name=='sE68S62') {
        ...
        for (var i=0;i<rooms.length;i++) {
          ...
          if (exits2[1] != undefined&& !(_.contains(rooms2,exits2[1]))) rooms2.push(exits2[1]);
          if (exits2[3] != undefined&& !(_.contains(rooms2,exits2[3])))  rooms2.push(exits2[3]);
          if (exits2[5] != undefined&& !(_.contains(rooms2,exits2[5])))  rooms2.push(exits2[5]);
          if (exits2[7] != undefined&& !(_.contains(rooms2,exits2[7])))  rooms2.push(exits2[7]);
