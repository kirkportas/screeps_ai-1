...
var mainScout = {
    ...
    run: function(room) {
      if (room.memory.scout===undefined||Object.keys(room.memory.scout).length<2) {
        ...
        for (var i=0;i<rooms.length;i++) {
          ...
          if (exits2[3] != undefined&& !(_.contains(rooms2,exits2[3]))&& exits2[3]!=room.name)  rooms2.push(exits2[3]);
          if (exits2[5] != undefined&& !(_.contains(rooms2,exits2[5]))&& exits2[5]!=room.name)  rooms2.push(exits2[5]);
