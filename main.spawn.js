...
var mainSpawn = {
  ...
  if (containers.length>=1) {
    ...
    } else if(upgraders < 1 || ((centralContainer.store[RESOURCE_ENERGY]>centralContainer.storeCapacity*0.75 || centralContainer.store[RESOURCE_ENERGY]>20000) && upgraders<6)) {
      var energyAvav = spawn.room.energyCapacityAvailable;
