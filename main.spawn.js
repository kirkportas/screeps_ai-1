var mainSpawn = {
    ...
    var buildersNeeded = Math.min(1,Math.ceil(energyNeeded/2000));
  ...
  if (containers>=1) {
    if(haulers < 5) {
      ...
      var newName = Game.spawns['Spawn1'].createCreep([WORK,WORK,CARRY,CARRY,CARY,CARY,MOVE,MOVE], findNextName('upgrader'), {role: 'upgrader'});
