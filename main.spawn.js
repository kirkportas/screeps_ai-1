...
var mainSpawn = {
  ...
  global.spawnArmy = function(spawn) {
    ...
    if (_.filter(Game.creeps, (creep)  => creep.memory.manual == '3').length<1) { //MELLEE
      if (createCreepAdvanced(spawn,'attacker',createBody({tough:0,move:1,attack:0}),{flag:'attack',manual:'3'})) return true;
    }
