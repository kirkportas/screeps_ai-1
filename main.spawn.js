...
var mainSpawn = {
  ...
  if (containers.length>=1) {
    ...
    } else if(upgraders < 1 || ((centralContainer.store[RESOURCE_ENERGY]>centralContainer.storeCapacity*0.75 || centralContainer.store[RESOURCE_ENERGY]>2000) && upgraders<2)) {
      var energyAvav = spawn.room.energyCapacityAvailable;
      var modules=[];
      if (links.length>=2) {
        energyAvav-=200;
