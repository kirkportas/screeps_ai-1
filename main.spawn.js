...
var mainSpawn = {
    ...
    if (centralContainer.store[RESOURCE_ENERGY]>centralContainer.storeCapacity*0.75) upgradersNeeded+=2;
  ...
  if (containers.length>=1) {
    if(haulers < haulersNeeded) {
      ...
      createCreepAdvanced(spawn,'warrior',createBody({move:4,rangedAttack:4}));
