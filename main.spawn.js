var mainSpawn = {
    ...
    var buildersNeeded = Math.min(6,Math.max(1,Math.ceil( (energyNeeded/2000) + (repairNeeded/100000) )));
    ...
    for (var i=0;i<sources.length;i++) {
      ...
      if (energyAvav>=700) {
        console.log(Game.getObjectById(source.miners[0].id).ticksToDecay);
  ...
  if (containers>=1) {
    ...
    } else if(upgraders < 1 || (centralContainer.store[RESOURCE_ENERGY]>1500 && upgraders<10)) {
