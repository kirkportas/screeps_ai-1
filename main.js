...
module.exports.loop = function () {
  ...
  var c1 = _.filter(Game.creeps, (creep)  => creep.memory.manual == '1').length;
  var c2 = _.filter(Game.creeps, (creep)  => creep.memory.manual == '1').length;
  if (c1<1) createCreepAdvanced(Game.spawns['Spawn1'],'attacker',createBody({tough:8,move:8,heal:4}),{targetRoom:'E68S62',flag:'attack',manual='1'});
  if (c2<1) createCreepAdvanced(Game.spawns['Spawn2'],'attacker',createBody({tough:8,move:8,attack:8}),{targetRoom:'E68S62',flag:'attack',manual='2'});
