...
module.exports.loop = function () {
  ...
  if (_.filter(Game.creeps, (creep)  => creep.memory.manual == '2').length<3) createCreepAdvanced(Game.spawns['Spawn1'],'attacker',createBody({tough:8,move:8,heal:4}),{targetRoom:'E68S62',flag:'attack',manual:'1'});
